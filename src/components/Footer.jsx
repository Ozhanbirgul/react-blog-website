        ...
        <div className='bg-gray-900'>
            <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
                <div className='grid mb-8 lg:grid-cols-6'>
                    ...
                    <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        ...
                        <form className='mt-4 flex flex-col md:flex-row'>
                            <input type="email" name='email' id='email'
                                className='flex-grow w-full h-12 px-4 mb-3 transition duration-200
                                 bg-white border border-gray-300 rounded shadow-sm aspect-auto md:mr-2
                                 md:mb-0 focus:border-purple-400 focus:outline-none focus:shadow' />
                            <button type='submit' className='inline-flex items-center justify-center 
                            h-12 px-6 font-medium tracking-wide text-white transition duration-200 
                            rounded shadow-md hover:bg-orange-500 focus:outline-none border'>
                                Subscribe
                            </button>
                        </form>
                        ...
                        <p className='mt-4 text-gray-500 '>
                            ...
                            architecto laborum necessitatibus a quo fugit rem ipsa deleniti qui.
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid illum
                            architecto laborum necessitatibus a quo fugit rem ipsa deleniti qui.
                        </p>
                    </div>
                ...
                <div className='flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row'>
                    <p className='text-sm text-gray-500 '>Copyright 2025 | All right resereved.</p>
